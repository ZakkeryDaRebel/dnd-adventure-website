import type {
  DNDStatblock,
  DamageStatblock,
  SpellcasterStatblock,
} from "../../../dnd-rules";

function isDamageStatblock(stat: DNDStatblock): stat is DamageStatblock {
  return "damage" in stat;
}

function isSpellcasterStatblock(
  stat: DNDStatblock,
): stat is SpellcasterStatblock {
  return "spellslots" in stat;
}

export function DisplayStatBlock({ statblock }: { statblock: DNDStatblock }) {
  return (
