import { changeName } from "../../../dnd-rules";
import type { Adventure } from "../../../features/adventure";
import { GUARD_SPEAR, WOLF } from "../../dnd-data/";

export const DARK_FOREST_ADVENTURE: Adventure = {
  meta: {
    id: "dark-forest",
    title: "The Dark Forest",
    description: "A simple Medieval solo D&D adventure for a level 1 player",
    startNode: "start",
  },
  story: {
    start: {
